About vectormath-feedstock
==========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/vectormath-feedstock/blob/main/LICENSE.txt)
...
Development: https://github.com/aranzgeo/vectormath

Documentation: http://vectormath.readthedocs.io/
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=3628&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/vectormath-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `vectormath` can be installed with `conda`:
...
```
mamba install vectormath
```

It is possible to list all of the versions of `vectormath` available on your platform with `conda`:
...
```
mamba search vectormath --channel conda-forge
```
...
mamba repoquery search vectormath --channel conda-forge

# List packages depending on `vectormath`:
mamba repoquery whoneeds vectormath --channel conda-forge

# List dependencies of `vectormath`:
mamba repoquery depends vectormath --channel conda-forge
```
